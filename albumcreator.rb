...
image_url = Net::HTTP.get(URI("http://www.flickr.com/explore/interesting/7days/"))
...
albumfontsize  = adjust_fontsize(album, albumfont, img2.columns * 0.8, img2.columns * 0.3)
artistfontsize = adjust_fontsize(artist, artistfont, img2.columns * 1.0, img2.columns * 0.4)

d = Draw.new
d.annotate(img2, 0,0,0,0, album) {
...
d.annotate(img2, 0,0,0,0, artist) {
